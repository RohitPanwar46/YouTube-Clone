...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-[100vw] top-0 left-0 right-0 h-16 bg-[#0f0f0f] shadow-lg z-50 flex items-center justify-between px-4">
      ...
      <div className="flex-1 max-w-lg sm:max-w-xl md:max-w-2xl mx-8 flex justify-center">
        <div className="flex w-full max-w-xl">
          <form onSubmit={handleSubmit} className="flex md:w-full w-[60%]">
            <input
