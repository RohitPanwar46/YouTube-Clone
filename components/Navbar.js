...
const Navbar = () => {
  ...
  // Close dropdown and mobile search when clicking outside
  useEffect(() => {
  ...
  return (
    <>
      ...
      {showMobileSearch && (
        <div className="fixed top-16 left-0 right-0 bg-[#0f0f0f] p-4 z-50 md:hidden flex items-center">
          <form 
            ref={searchRef}
      ...
      {/* Navbar */}
      <header className="fixed w-full top-0 left-0 right-0 h-16 bg-[#0f0f0f] shadow-lg z-50 flex items-center justify-between px-4">
        {/* Left Side - Logo */}
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {/* Action Buttons - Hidden on small mobile screens */}
